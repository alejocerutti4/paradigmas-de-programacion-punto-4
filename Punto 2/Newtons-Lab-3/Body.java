...
{
    protected static final double GRAVITY = 7.8;
    protected static final Color defaultColor = new Color(255, 216, 0);
     ...
     */
    protected void applyGravity(Body other)
    {
