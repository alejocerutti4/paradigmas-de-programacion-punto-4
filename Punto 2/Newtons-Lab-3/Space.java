...
public class Space extends World
{
    ...
    {
        int sizeP = 20 + Greenfoot.getRandomNumber(30);
        double massP = sizeP * 7.0;
        int directionP = Greenfoot.getRandomNumber(360);
        double speedP = Greenfoot.getRandomNumber(150) / 100.0;
        addObject (new BodyJugador(sizeP, massP, new Vector(directionP, speedP), new Color(255, 0, 0)), 20, 20);
